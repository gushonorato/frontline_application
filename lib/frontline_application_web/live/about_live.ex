defmodule FrontlineApplicationWeb.AboutLive do
  ...
  I'm Gustavo Honorato, a 42 years old software developer based in Niterói, Brazil, a mid-sized city right next to the famous Rio de Janeiro. While Niterói may not be widely known internationally, it offers stunning views of Rio's skyline (which, I must say, is a great motivator when debugging tricky Elixir code). Now, you might be wondering about the time zone difference, Niterói follows Brasília Standard Time (BRT, UTC-3). To ensure seamless collaboration, I'm flexible with my working hours and open to adjusting it. Additionally, I am available to relocate to the U.S. if needed.
  ...
  Over nearly 20 years, I've founded 4 startups. Only one succeeded, but the failures were just as valuable. I like to think of myself as a developer who embraces challenges and isn't afraid to take risks. But since this is a developer role, let's dive into the technical side of things.
  ...
  I've always believed that the best way to grow as a developer is by engaging with the community. I'm an [active participant in the Elixir Forum](https://elixirforum.com/u/gushonorato/activity), where I frequently help answer questions and discuss best practices.
  ...
  defp render_resume(assigns) do
    assigns =
      assign(
        assigns,
        :content,
        @resume |> Earmark.as_html!(escape: false) |> raw() |> render_code_blocks()
      )
